...
<html>
<head>
	<title>Fine Collectiong and Records</title>
...
<div class="w3-third w3-container w3-col s3 ">
  	<button type="button" onclick="document.getElementById('id01').style.display='block'" class="w3-margin w3-block w3-padding w3-btn w3-green w3-hover-blue">Collect Fine</button>
  ...
  <div id="id01" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-4">
      ...
      <div class="w3-container w3-margin w3-border">
		        ...
		        <input type="number" name="Tracid" class="w3-input w3-border">
		        <label>Fine Rate: </label>
		        <input type="number" name="fine" class="w3-input w3-border"><br>
		        <label>Fine Status: </label>
		        <input type="radio" name="finestat" class="w3-radio w3-border w3-padding" value="paid"><label><b>&nbsp;Paid</b></label>&nbsp;
		        <input type="radio" name="finestat" class="w3-radio w3-border w3-padding" value="unpaid"><label><b>&nbsp;Unpaid</b></label><br><br>
		</div>
