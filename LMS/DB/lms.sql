...
insert  into `books`(`bookid`,`bookname`,`author`) values ('B0001','Operating System Concepts','Andrew Tanenbum');
...
insert  into `booksid`(`copyid`,`bookid`,`status`) values ('B0001001','B0001',0),('B0001002','B0001',0),('B0001003','B0001',0),('B0001004','B0001',0),('B0001005','B0001',0);
...
CREATE TABLE `candidate` (
  ...
  CONSTRAINT `candidate` FOREIGN KEY (`deptid`) REFERENCES `department` (`deptid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `fine` (
  ...
  KEY `transaction` (`tid`),
  CONSTRAINT `transaction` FOREIGN KEY (`tid`) REFERENCES `issue` (`tid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `issue` (
  ...
  KEY `owner` (`ownerid`),
  KEY `booksid` (`bookid`),
  CONSTRAINT `booksid` FOREIGN KEY (`bookid`) REFERENCES `booksid` (`copyid`),
  CONSTRAINT `owner` FOREIGN KEY (`ownerid`) REFERENCES `candidate` (`cid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
